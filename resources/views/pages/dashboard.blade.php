...
@section('content')
    ...
    <div class="container-fluid px-0">
        <div id="carouselId" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img src="img/carousel-1.jpg" class="img-fluid carousel-set" alt="First slide">
                    <div class="carousel-caption">
                        <div class="container carousel-content">
                            <h6 class="text-secondary h4 animated fadeInUp">Website Informasi</h6>
                            <h1 class="text-white display-1 mb-4 animated fadeInRight">EKSTRAKULIKULER</h1>
                            {{-- <p class="mb-4 text-white fs-5 animated fadeInDown">Lorem ipsum dolor sit amet elit. Sed
                          efficitur quis purus ut interdum. Pellentesque aliquam dolor eget urna ultricies tincidunt.</p> --}}
                            <a href="#read" class="me-2"><button type="button"
                            ...
                            <a href="" class="ms-2"><button type="button"
                                    class="px-4 py-sm-3 px-sm-5 btn btn-primary rounded-pill carousel-content-btn2 animated fadeInRight">Register</button></a>
                        </div>
                    </div>
                </div>
        ...
        <!-- About Start -->
        <div id="read" class="container-fluid py-5 my-5">
            <div class="container pt-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <h1 class="mb-4">EKSTRAKULIKULER SMKS MAHAPUTRA CERDAS UTAMA</h1>
                        <p>SMKS Mahaputra Cerdas Utama didirikan pada 22 Agustus tahun 2016, adalah salah satu SMK swasta
                            yang ada di Kabupaten Bandung yang memiliki program study Multimedia (MM) dan Rekyasa Perangkat
                            Lunak (RPL), menjadi sekolah pertama di Kabupaten Bandung dengan Konsep Green School atau
                            Sekolah Hijau yang ramah lingkungan SMKS Mahaputra Cerdas Utama berkomitmen untuk mencetak
                            Sumber Daya Manusia (SDM) yang unggul di era 4.0.</p>
                        <p class="mb-4">Di SMKS Mahaputra Cerdas Utama memiliki beberapa ekstrakulikuler atau organisasi
                            yang dapat mengembangkan bakat minat siswa siswi di SMKS Mahaputra Cerdas Utama. </p>
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="ps-4">
                                <h5 class="mb-2">Register Now !</h5>
                                <h4 class="text-secondary mb-0">Join Mahaputra Extra Curricular</h4>
                            </div>
                            <div class="pl-6 col text-end">
                                <div class="pl-6 col text-end">
                                    <a href="#" class="btn btn-outline-secondary py-md-3 px-md-5">Register</a>
                                </div>
                            </div>
                            <hr>
                        </div>
        ...
        <!-- Services Start -->
        <div id="ekskul" class="container-fluid services py-5 mb-5">
            <div class="container">
                <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                    <h1>LIST EKSTRAKULIKULER DI SMKS MAHAPUTRA</h1>
                </div>
                <div class="row g-5 services-inner">
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".5s">
                        <div class="services-item bg-light">
                            <div class="p-4 text-center services-content">
                                <div class="services-content-icon">
                                    <i class="fas fa-video fa-7x mb-4 text-primary"></i>
                                    <h4 class="mb-3">MCM</h4>
                                    <p class="mb-4">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut interdum.
                                        Aliquam dolor eget urna ultricies tincidunt.</p>
                                    <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">Read
                                        More</a>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".7s">
                        <div class="services-item bg-light">
                            <div class="p-4 text-center services-content">
                                <div class="services-content-icon">
                                    <i class="fa fa-volleyball-ball fa-7x mb-4 text-primary"></i>
                                    <h4 class="mb-3">VOLLY</h4>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".5s">
                        <div class="services-item bg-light">
                            <div class="p-4 text-center services-content">
                                <div class="services-content-icon">
                                    <i class="fas fa-fist-raised fa-7x mb-4 text-primary"></i>
                                    <h4 class="mb-3">PENCAK SILAT</h4>
                                    <p class="mb-4">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                                        interdum.
                                        Aliquam dolor eget urna ultricies tincidunt.</p>
                                    <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">Read
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".7s">
                        <div class="services-item bg-light">
                            <div class="p-4 text-center services-content">
                                <div class="services-content-icon">
                                    <i class="fas fa-quran fa-7x mb-4 text-primary"></i>
                                    <h4 class="mb-3">ROHIS</h4>
                                    <p class="mb-4">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                                        interdum.
                                        Aliquam dolor eget urna ultricies tincidunt.</p>
                                    <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">Read
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".7s">
                        <div class="services-item bg-light">
                            <div class="p-4 text-center services-content">
                                <div class="services-content-icon">
                                    <i class="fas fa-futbol fa-7x mb-4 text-primary"></i>
                                    <h4 class="mb-3">FUTSAL</h4>
                                    <p class="mb-4">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                                        interdum.
                                        Aliquam dolor eget urna ultricies tincidunt.</p>
                                    <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">Read
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".7s">
                        <div class="services-item bg-light">
                            <div class="p-4 text-center services-content">
                                <div class="services-content-icon">
                                    <i class="fas fa-book-open fa-7x mb-4 text-primary"></i>
                                    <h4 class="mb-3">TIM LITERASI</h4>
                                    <p class="mb-4">Lorem ipsum dolor sit amet elit. Sed efficitur quis purus ut
                                        interdum.
                                        Aliquam dolor eget urna ultricies tincidunt.</p>
                                    <a href="" class="btn btn-secondary text-white px-5 py-3 rounded-pill">Read
        ...
        <!-- Project Start -->
        <div id="dokumentasi" class="container-fluid project py-5 mb-5">
            <div class="container">
                <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
                ...
                <div class="row g-5">
                            ...
                            <div class="project-img">
                                ...
                                <div class="project-content">
                                    <a href="#" class="text-center">
                                        <p class="m-0 text-white">EKSTRAKULIKULER</p>
                                        <h4 class="text-secondary">RPL</h4>
                            ...
                            <div class="project-img">
                                ...
                                <div class="project-content">
                                    <a href="#" class="text-center">
                                        ...
                                        <p class="m-0 text-white">EKSTRAKULIKULER</p>
                                        <h4 class="text-secondary">MCM</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="project-item">
                            <div class="project-img">
                                ...
                                <div class="project-content">
                                    <a href="#" class="text-center">
                                        <p class="m-0 text-white">EKSTRAKULIKULER</p>
                                        <h4 class="text-secondary">VOLLY</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="project-img">
                                ...
                                <div class="project-content">
                                    <a href="#" class="text-center">
                                        ...
                                        <p class="m-0 text-white">EKSTRAKULIKULER</p>
                                        <h4 class="text-secondary">PANAHAN</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="project-img">
                                ...
                                <div class="project-content">
                                    <a href="#" class="text-center">
                                        ...
                                        <p class="m-0 text-white">EKSTRAKULIKULER</p>
                                        <h4 class="text-secondary">PENCAK SILAT</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="project-img">
                                ...
                                <div class="project-content">
                                    <a href="#" class="text-center">
                                        ...
                                        <p class="m-0 text-white">EKTRAKULIKULER</p>
                                        <h4 class="text-secondary">PASKIBRA</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay=".7s">
                        <div class="project-item">
                            <div class="project-img">
                                <img src="img/project-7.jpg" class="img-fluid w-100 rounded" alt="">
                                <div class="project-content">
                                    <a href="#" class="text-center">

                                        <p class="m-0 text-white">EKTRAKULIKULER</p>
                                        <h4 class="text-secondary">ROHIS</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="project-img">
                                ...
                                <div class="project-content">
                                    <a href="#" class="text-center">
                                        ...
                                        <p class="m-0 text-white">EKTRAKULIKULER</p>
                                        <h4 class="text-secondary">FUTSAL</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="project-img">
                                ...
                                <div class="project-content">
                                    <a href="#" class="text-center">
                                        ...
                                        <p class="m-0 text-white">EKTRAKULIKULER</p>
                                        <h4 class="text-secondary">TIM LETERASI</h4>
                                    </a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="rounded team-item">
                        <div class="team-content">
                            <div class="team-img-icon">
                                ...
                                <div class="team-name text-center py-3">
                                    <h4 class="">Zahwa Wakil</h4>
                                    <p class="m-0">PANAHAN</p>
                                </div>
                                <div class="team-icon d-flex justify-content-center pb-4">
                                    <a class="btn btn-square btn-secondary text-white rounded-circle m-1"
                                        href=""><i class="fab fa-facebook-f"></i></a>
                    ...
                    <div class="rounded team-item">
                        <div class="team-content">
                            <div class="team-img-icon">
                                ...
                                <div class="team-name text-center py-3">
                                    <h4 class="">Tia Racing</h4>
                                    <p class="m-0">PENCAK SILAT</p>
                                </div>
                                <div class="team-icon d-flex justify-content-center pb-4">
                                    <a class="btn btn-square btn-secondary text-white rounded-circle m-1"
                                        href=""><i class="fab fa-facebook-f"></i></a>
